...
//https://stackoverflow.com/questions/12428138/selecting-elements-for-clipping-in-web-pages-with-javascript
...
//https://developer.mozilla.org/en-US/docs/AJAX/Getting_Started
  function makeRequest(url) {
    ...
    httpRequest.send('url=' + encodeURIComponent(window.document.location) + '&body=' + encodeURIComponent(md));
  }
  ...
  // TODO add hawk authentication
  makeRequest("http://192.168.1.10:8000/api/bookmarklet");